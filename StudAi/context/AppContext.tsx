...
interface AppContextProps {
    ...
    // Datos de entrada por voz (para Login)
    voiceInput: VoiceInputData | null;
    setVoiceInput: (data: VoiceInputData | null) => void;
}
...
export const AppProvider = ({ children }: AppProviderProps) => {
    ...
    const [voiceInput, setVoiceInput] = useState<VoiceInputData | null>(null);
